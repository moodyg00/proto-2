...
const PAGES = [
  ...
  ['jobs',                'Work Orders',          'Field work orders / jobs.',                                  'Operations',           'app/Filament/Resources/JobResource.php'],
  ['schedulings',         'Schedule',             'Calendar of scheduled work.',                                'Operations',           'app/Filament/Resources/SchedulingResource.php'],
  ['schedulings/availability', 'Availability',    'Crew/resource availability windows.',                        'Operations',           'app/Filament/Resources/SchedulingResource (availability page)'],
  ['schedulings/booking-links','Booking Links',   'Shareable booking links for customers.',                     'Operations',           'app/Filament/Resources/SchedulingResource (booking links page)'],
  ['estimates',           'Estimates',            'Estimates and quotes.',                                      'Operations',           'app/Filament/Resources/EstimateResource.php'],
  ['invoices',            'Invoices',             'Customer invoices.',                                         'Operations',           'app/Filament/Resources/InvoiceResource.php'],
  ...
  ['recurring-invoices',  'Recurring Invoices',   'Subscription and retainer invoice schedules.',               'Accounting',           'app/Filament/Resources/RecurringInvoiceResource.php'],
  ['catalog',             'Catalog',              'Inventory and product catalog.',                             'Accounting',           'app/Filament/Resources/CatalogResource.php'],
  ['offerings',           'Offerings',            'Service offerings and packages.',                            'Accounting',           'app/Filament/Resources/OfferingResource.php'],
  ...
  ['mcp-servers',             'MCP',                    'MCP server registry and health.',                      'Integrations',         'app/Filament/Resources/McpServerResource.php'],
