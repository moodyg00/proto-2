...
async function main() {
  ...
  try {
    ...
    const chartAccountRows = [
      {
        id: ids.chartAccounts.cash,
        code: '1000',
        name: 'Operating Cash',
        type: 'asset',
      ...
      {
        id: ids.chartAccounts.receivables,
        code: '1100',
        name: 'Accounts Receivable',
        type: 'asset',
        description: 'Customer receivables and open balances.',
        is_active: true,
        created_by: ids.users.admin,
        updated_by: ids.users.admin,
      },
      {
        id: ids.chartAccounts.clearing,
        code: '1200',
        name: 'Merchant Clearing',
        type: 'asset',
        description: 'Clearing account for card and payout activity.',
        is_active: true,
        created_by: ids.users.admin,
        updated_by: ids.users.admin,
      },
      {
        id: ids.chartAccounts.payables,
        code: '2000',
        name: 'Accounts Payable',
        type: 'liability',
        description: 'Vendor obligations awaiting payment.',
        is_active: true,
        created_by: ids.users.admin,
        updated_by: ids.users.admin,
      },
      {
        id: ids.chartAccounts.serviceRevenue,
        code: '4100',
        name: 'Service Revenue',
        type: 'income',
        description: 'Operating revenue from service delivery.',
        is_active: true,
        created_by: ids.users.admin,
        updated_by: ids.users.admin,
      },
      {
        id: ids.chartAccounts.softwareExpense,
        code: '5200',
        name: 'Software & Subscriptions',
        type: 'expense',
        description: 'Recurring software and SaaS charges.',
        is_active: true,
        created_by: ids.users.admin,
        updated_by: ids.users.admin,
      },
      {
        id: ids.chartAccounts.marketingExpense,
        code: '5300',
        name: 'Marketing Expense',
        type: 'expense',
        description: 'Paid media and campaign spend.',
        is_active: true,
        created_by: ids.users.admin,
        updated_by: ids.users.admin,
      },
