...
export const NAV_GROUPS: NavGroup[] = [
  {
    ...
    items: [
      ...
      { href: '/admin/calendar',                   label: 'Calendar',       icon: CalendarDays, sort: 2 },
      { href: '/admin/calendar/availability',      label: 'Availability',   icon: Clock,        sort: 3 },
      { href: '/admin/calendar/booking-links',     label: 'Booking Links',  icon: LinkIcon,     sort: 4 },
