...
export const NAV_GROUPS: NavGroup[] = [
  {
    ...
    sort: 1,
    items: [
      { href: '/admin/jobs',                       label: 'Work Orders',    icon: Briefcase,    sort: 1 },
      { href: '/admin/schedulings',                label: 'Schedule',       icon: CalendarDays, sort: 2 },
      { href: '/admin/schedulings/availability',   label: 'Availability',   icon: Clock,        sort: 3 },
      { href: '/admin/schedulings/booking-links',  label: 'Booking Links',  icon: LinkIcon,     sort: 4 },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/admin/balances',            label: 'Ledger',             icon: Scale,       sort: 3 },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/admin/mcp-servers',      label: 'MCP', icon: Server,   sort: 2 },
    ],
  },
  {
